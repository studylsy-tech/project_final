...
<link rel="stylesheet" href="${path}/resources/css/views/footer/support.css">
	<div class="support-container" style="max-width:800px !important; margin: 60px auto;">
    <div class="support-header" style="text-align: center;">
        <h1>고객센터</h1>
    ...
    <div class="contact-info" style="margin-bottom: 20px;">
        ...
        <div class="info-item" style="margin-bottom: 20x;">
            <span class="icon">💬</span>
        ...
        <div class="info-item" style="margin-bottom: 20px;">
            ...
            <span class="value">부산광역시 충렬대로 미남역 3번 출구 에서 도보 5분)</span>
        </div>
    </div>
